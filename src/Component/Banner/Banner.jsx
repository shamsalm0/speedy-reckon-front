    ...
    return (
        <div>
            <div className='lg:flex justify-center lg:mb-10'>
                ...
                <div className=''>
                    <h2 className=' font-bold text-2xl text-center leading-10'>We Care About Your Car</h2>
                    <p className='lg:text-base  text-[#5e5e5e] font-normal leading-7 mb-7'>We have been distributing an outstanding quality of products in the <br /> out-motive market - spealizing in the remanufacture, supply and <br /> survicing of diesel fuel injections and <br /> automotive vehicle parts and accessories</p>
